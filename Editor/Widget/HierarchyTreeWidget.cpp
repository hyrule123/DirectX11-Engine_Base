...
namespace core::editor
{
	...
	void HierarchyTreeWidget::update_UI()
	{
		Super::update_UI();
	...
	void HierarchyTreeWidget::clear()
	{
		m_root = nullptr;
		m_root = new_entity<TreeNode>();

		m_root->set_owner(std::static_pointer_cast<HierarchyTreeWidget>(shared_from_this()));
		m_root->m_b_root = true;
	}
	void HierarchyTreeWidget::set_selected_node(const s_ptr<TreeNode>& node)
	{
