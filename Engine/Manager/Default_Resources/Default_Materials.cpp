...
#pragma region DEFAULT
		...
		s_ptr<Material> RectMaterial = new_entity<Material>();
...
#pragma region SPRITE
		...
		s_ptr<Material> spriteMaterial = new_entity<Material>();
...
#pragma region UI
		...
		s_ptr<Material> uiMaterial = new_entity<Material>();
...
#pragma region GRID
		...
		s_ptr<Material> gridMaterial = new_entity<Material>();
...
#pragma region PARTICLE
		...
		s_ptr<Material> particleMaterial = new_entity<Material>();
...
#pragma region POSTPROCESS
		...
		s_ptr<Material> postProcessMaterial = new_entity<Material>();
...
#pragma region FORWARD_3D
		...
		s_ptr<Material> basic3DMaterial = new_entity<Default3DMtrl>();
...
#pragma region LIGHT
		{
			...
			s_ptr<Material> lightMaterial = new_entity<Material>();
...
#pragma region MERGE
		...
		s_ptr<Material> mergeMaterial = new_entity<Material>();
...
#pragma region DEBUG
		...
		s_ptr<DebugMaterial> debugMaterial = new_entity<DebugMaterial>();
