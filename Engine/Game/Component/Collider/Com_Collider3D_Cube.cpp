...
namespace core
{
	Com_Collider3D_Cube::Com_Collider3D_Cube()
		: Com_Collider3D_Shapes(Com_Collider3D_Cube::s_concrete_class_name, eCollider3D_Shape::Cube)
	...
	std::vector<physx::PxShape*> Com_Collider3D_Cube::AddShapeFromChild()
	{
		...
		physx::PxShape* shape = PhysXInstance::get_inst().GetPhysX().createShape(m_offsetHalfScale, *material, true);
